    ...
    return (
        <footer className="bg-black body-font ">
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto pt-8  px-5 flex flex-wrap flex-col shadow-2xl sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2020 Panaverse Dao — @HassanFarooq703 </p>
